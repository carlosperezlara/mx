...
mxGeometry::mxGeometry() :
  ...
  fY(0),
  fZ(0),
  fSi_a0(0.190),//0.190cm - 40um spacing (62.04cm) //0.186
  fSi_a1(1.547),//1.547cm - 40um spacing (62cm) //1.490
  fSi_a2(0.050),//0.5mm
  fW_a0(6.200), //62cm //6.4
  fW_a1(6.200), //62cm //6.4
  fW_a2(0.204), //2mil
  fPbWO4_a0(2.100),
  fPbWO4_a1(2.100),
  fPbWO4_a2(25.00),
...
{
  float mx[96] = {
    +3.005,  -3.295,  -3.295,  -9.595,  -6.845, -13.145,  +9.305,  +3.005,  +9.305, +15.605, +12.855, +19.155, 
    -3.005,  +3.295,  +3.295,  +9.595,  +6.845, +13.145,  -9.305,  -3.005,  -9.305, -15.605, -12.855, -19.155, 
    -0.775,  -7.075,  -7.075, -13.375, -10.625, -16.925,  +5.524,  -0.775,  +5.524, +11.824,  +9.075, +15.374, 
    +0.775,  +7.075,  +7.075, +13.375, +10.625, +16.925,  -5.524,  +0.775,  -5.524, -11.824,  -9.075, -15.374, 
    -3.005,  +3.295,  +3.295,  +9.595,  +6.845, +13.145,  -9.305,  -3.005,  -9.305, -15.605, -12.855, -19.155, 
    +3.005,  -3.295,  -3.295,  -9.595,  -6.845, -13.145,  +9.305,  +3.005,  +9.305, +15.605, +12.855, +19.155, 
    +0.775,  +7.075,  +7.075, +13.375, +10.625, +16.925,  -5.524,  +0.775,  -5.524, -11.824,  -9.075, -15.374, 
  ...
  float my[96] = {
    +16.926, +16.926, +10.625, +10.625,  +4.325,  +4.325, +16.926, +10.625, +10.625, +10.625,  +4.325,  +4.325, 
    -16.926, -16.926, -10.625, -10.625,  -4.325,  -4.325, -16.926, -10.625, -10.625, -10.625,  -4.325,  -4.325, 
    +19.155, +19.155, +12.855, +12.855,  +6.555,  +6.555, +19.155, +12.855, +12.855, +12.855,  +6.555,  +6.555, 
    -19.155, -19.155, -12.855, -12.855,  -6.555,  -6.555, -19.155, -12.855, -12.855, -12.855,  -6.555,  -6.555, 
    +16.926, +16.926, +10.625, +10.625,  +4.325,  +4.325, +16.926, +10.625, +10.625, +10.625,  +4.325,  +4.325, 
    -16.926, -16.926, -10.625, -10.625,  -4.325,  -4.325, -16.926, -10.625, -10.625, -10.625,  -4.325,  -4.325, 
    +19.155, +19.155, +12.855, +12.855,  +6.555,  +6.555, +19.155, +12.855, +12.855, +12.855,  +6.555,  +6.555, 
  ...
  float sx[24] = { -6.300,  +0.000,  +6.300, -12.600,  -6.300,  +0.000,  +6.300, +12.600, -16.150,  -9.850,  +9.850, +16.150, 
		   -16.150,  -9.850,  +9.850, +16.150, -12.600,  -6.300,  +0.000,  +6.300, +12.600,  -6.300,  +0.000,  +6.300, };
  float sy[24] = { +16.150, +16.150, +16.150,  +9.850,  +9.850,  +9.850,  +9.850,  +9.850,  +3.550,  +3.550,  +3.550,  +3.550, 
		   -3.550,  -3.550,  -3.550,  -3.550,  -9.850,  -9.850,  -9.850,  -9.850,  -9.850, -16.150, -16.150, -16.150, };
...
void mxGeometry::UpdateSiW(int key) {
  ...
  if(typ==0) {
    x -= sgnAR*sgnTB*((k%128)/4)*(fSi_a0+0.004);
    y += sgnTB*fSi_DLY[k%4]*(fSi_a1+0.004);
    //nx -= sgnAR*sgnTB*((k%128)/4);
    //ny += sgnTB*fSi_DLY[k%4];
  } else {
    y -= sgnTB*((k%128)/4)*(fSi_a0+0.004);
    x -= sgnAR*sgnTB*fSi_DLY[k%4]*(fSi_a1+0.004);
    //ny -= sgnTB*((k%128)/4);
